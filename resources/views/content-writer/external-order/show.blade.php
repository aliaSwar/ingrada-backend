                                                                  ...
                                                                  <div class="col-lg-3">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group mb-0">
                                                                            ...
                                                                            <input type="text" name="type" class="custom-select form-control bg-white custom-radius "  value="{{ old('type', $order->type??'') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group mb-0">
                                                                            <label for="exampleInputText3" class="h5">End Dates</label>
                                                                            <input type="date" name="limit_date" class="custom-select form-control bg-white custom-radius "  value="{{ old('limit_date', $order->limit_date) }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group mb-0">
                                                                            <label for="exampleInputText3" class="h5">Price</label>
                                                                            <input type="text" name="final_price" class=" form-control bg-white custom-radius "  value="{{$order->primary_price}}">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group mb-0">
                                                                            ...
                                                                            <input type="text" name="pereferce" class=" form-control bg-white custom-radius "  value={{ old('pereferce', $order->pereferce??'') }}>
                                                                        </div>
                                                                    </div>
                                                                    @if ($order->value!=null)
                                                                    <div class="col-lg-3">
                                                                      <div class="form-group mb-0">
                                                                          ...
                                                                          <input type="text" name="value" class=" form-control bg-white custom-radius "  value="{{ old('value', $order->value) }}">
                                                                      </div>
                                                                  </div>
                                                                    @endif
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group mb-0">
                                                                            ...
                                                                            <input type="text" name ="scope" class=" form-control bg-white custom-radius "  value={{ old('scope', $order->scope??"") }}>
                                                                        </div>
                                                                    </div>
