                                        ...
                                        <table class="table table-bordered"
                                             ...
                                             <thead>
                                                  <tr>
                                                       ...
                                                       <th class="text-dark mb-0 font-16 font-weight-medium">Username
                                                       </th>
                                                       <th class="text-dark mb-0 font-16 font-weight-medium">Task</th>
                                                       <th class="text-dark mb-0 font-16 font-weight-medium">Category
                                                       </th>
                                                       <th class="text-dark mb-0 font-16 font-weight-medium">Role</th>
                                                       <th class="text-dark mb-0 font-16 font-weight-medium">Actions
                                                       </th>
                                                  </tr>
                                             </thead>
                                             <tbody>
