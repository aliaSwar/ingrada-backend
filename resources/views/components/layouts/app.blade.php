...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('dist/vendor/line-awesome/dist/line-awesome/css/line-awesome.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('dist/vendor/remixicon/fonts/remixicon.css') }}">
    <link rel="stylesheet"
        href="{{ asset('dist/vendor/tui-calendar/tui-date-picker/dist/tui-date-picker.css') }}">
    <link rel="stylesheet"
        href="{{ asset('dist/vendor/tui-calendar/tui-time-picker/dist/tui-time-picker.css') }}">
    <link rel="stylesheet"
